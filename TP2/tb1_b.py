...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 23 22:11:18 2019
...
freq2 = np.linspace(0, (N + M-1), N + M) / (10*fs)
...
#grafico del modulo la ventana propia
     ...
     f_ax5.plot(freq[0:int(N/2)], mod_signal[0:int(N/2),ii + 1])
...
#grafico del modulo la ventana con zero padding propia
     ...
     f_ax6.plot(freq2[0:int((N+M)/2)], mod_signal_padding[0:int((N + M)/2),ii + 1])
...
plt.plot(freq2[0:int((N + M)/2)], mod_signal_padding[0:int((N + M)/2),0], label=ventana[0])
plt.plot(freq2[0:int((N + M)/2)], mod_signal_padding[0:int((N + M)/2),2], label=ventana[2])
plt.plot(freq2[0:int((N + M)/2)], mod_signal_padding[0:int((N + M)/2),4], label=ventana[4])
plt.plot(freq2[0:int((N + M)/2)], mod_signal_padding[0:int((N + M)/2),6], label=ventana[6])
plt.plot(freq2[0:int((N + M)/2)], mod_signal_padding[0:int((N + M)/2),8], label=ventana[8])
